...
class KNN:
    ...
    def predict(self, X, num_loops=0):
        ...
        """
        if num_loops == 0:
            dis = self.compute_distances_no_loops(X)
        elif num_loops == 1:
            dis = self.compute_distances_one_loop(X)
        elif num_loops == 2:
            dis = self.compute_distances_two_loops(X)
        else:
    ...
    def predict_labels(self, dists):
        ...
        for i in range(num_test):
            ...
            closest_y = self.train_y[ind][:self.kls]
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            #########################################################################
            # TODO:                                                                 #
    ...
    def predict_labels_binary(self, dists):
        ...
        for i in range(num_test):
            ix = np.argmin(dists[i,:])
            pred[i] = self.train_y[ix]
